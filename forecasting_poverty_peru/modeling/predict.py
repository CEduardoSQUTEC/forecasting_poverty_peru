...
from poverty_forecasting_peru.config import MODELS_PATH, PROCESSED_PATH
from poverty_forecasting_peru.modeling.satmae_pp.fmow_rgb.models_vit import vit_large_patch16
